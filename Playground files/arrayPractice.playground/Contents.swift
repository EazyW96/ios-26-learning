...
var contactList = ["Shah" : "+60123456789", "Sohini" : "+0223456789"]

contactList.count
contactList.isEmpty

contactList["Nithya"] = "+0229876543"
contactList
...
contactList["Sohini"] = nil
contactList

var oldDictValue = contactList.removeValue(forKey: "Nithya:")
oldDictValue
contactList
...
let movieGenresSuperset: Set = ["Horror", "Romantic Comdey", "War", "Science Fiction", "Fantasy"]
